...
router.post('/', (req, res) => {
  ...
  const limits = { conservative: { initial: 10, intermediate: 25, stable: 50 }, moderate: { initial: 15, intermediate: 40, stable: 80 }, aggressive: { initial: 20, intermediate: 60, stable: 120 } };
